...
export function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div
        className="absolute top-1/4 right-1/4 w-72 h-72 rounded-full blur-3xl opacity-15 pointer-events-none"
        style={{ background: "#7c3aed" }}
      />
      <div
        className="absolute bottom-1/3 left-1/4 w-64 h-64 rounded-full blur-3xl opacity-10 pointer-events-none"
